        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                  <h2 class="page-heading">Author Name: <?php echo strtoupper($_GET['name']); ?></h2>
<?php 
...
$query2 = "SELECT * FROM post WHERE post.author={$_GET['id']}";
...
if(mysqli_num_rows($result2)){
  ...
  if ($page_number>1) {
    # code...
    echo '<li><a href="author.php?page='.($page_number-1).'&id='.($_GET['id']).'&name='.$_GET['name'].'">Prev</a></li>';
  }
  ...
  for ($i=1; $i <= $total_page ; $i++) { 
    ...
    echo '<li class='.$active.'><a href="author.php?page='.$i.'&id='.($_GET['id']).'&name='.$_GET['name'].'">'.$i.'</a></li>';
  }
  if ($total_page>$page_number) {
    # code...
    echo '<li><a href="author.php?page='.($page_number+1).'&id='.($_GET['id']).'&name='.$_GET['name'].'">Next</a></li>';
  }
  echo "</ul>";
